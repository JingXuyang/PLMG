...
class KeyframeProClient(object):
    ...
    def queue_advanced_snapshot(self, dir_path, base_file_name, snapshot_type="all", numbering="sequence", padding=4, overwrite=True):
        """
    ...
    def queue_export(self, path, width, height, quality="high", preset=3, profile="main", ignore_range=False, annotations=False, viewer_layout=False, detailed_logs=False):
        """
