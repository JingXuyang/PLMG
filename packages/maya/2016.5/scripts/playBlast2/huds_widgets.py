...
class _ColorButton(QtGui.QLabel):
    ...
    def mousePressEvent(self, event):
        ...
        color = QtGui.QColorDialog.getColor(oldColor)
        if color.isValid():
...
class _FontButton(QtGui.QFontComboBox):

    def __init__(self, font, parent=None):
        QtGui.QFontComboBox.__init__(self, parent=parent)
        self.setValue(font)
...
class _SetAllButton(QtGui.QPushButton):
    ...
    def __init__(self, key, widget, window=None, parent=None):
        ...
        QtGui.QPushButton.__init__(self, 'Set All')
...
class _SceneHUDItemDialog(QtGui.QDialog):
    ...
    def __init__(self, text='Spider', font='Arial', color='#DDD',
        ...
        scaleLab = QtGui.QLabel('Scale')
        self._scaleWgt = QtGui.QDoubleSpinBox()
        ...
        hposLab = QtGui.QLabel('HPos')
        self._hposWgt = QtGui.QDoubleSpinBox()
        ...
        # lay1 = QtGui.QFormLayout()
        # lay1.setFieldGrowthPolicy(QtGui.QFormLayout.AllNonFixedFieldsGrow)
        # lay1.setContentsMargins(0, 0, 0, 0)
        #
...
class _SceneHUDBarDialog(QtGui.QDialog):
    ...
    def __init__(self, color='#111', alpha=1, scale=1,
        ...
        self._topWgt = QtGui.QCheckBox()
        self._bottomWgt = QtGui.QCheckBox()
...
class _SceneHUDItem(QtGui.QLabel):
    ...
    def __init__(self, data={}, alignment='center',
        ...
        QtGui.QLabel.__init__(self, parent=parent._bgLab)
...
''' % self.color()
    ...
    def setValue(self, data, resize=True):
        ...
        # self.setFont(QtGui.QFont("Arial",20,QtGui.QFont.Bold))
    ...
    def updateText(self, data={}):
        ...
        if text:
            ...
            # self.setFont(QtGui.QFont(self._data['font'],self._data['scale']))

            self.setFont2(self._data)
            self.setText(evalText)


class _SceneHUDsBar(QtGui.QLabel):
...
class SceneHUDsPrefsWidget(QtGui.QFrame):
    category = 'Special'
    multiRows = True
...
''' % color
    ...
    def saveImage(self):
        r = QtGui.QFileDialog.getSaveFileName(parent=self, caption='Save')
        if r[0]:
            # print r[0]
...
'''
        ...
        if not self._maskBtn:
            self._maskBtn = QtGui.QPushButton('Mask', parent=self._bgLab)
